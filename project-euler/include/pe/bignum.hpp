...
inline std::string multiplyBigNumbers(std::string num1, std::string num2) {
    int len1 = num1.size();
    int len2 = num2.size();
...
// -1: str2 > str1
// 1: str1 > str2
inline int compare(std::string str1, std::string str2) {
...
inline std::string addBigNumbers(std::vector<std::string> numsVect) {
    std::vector<int> calc;
